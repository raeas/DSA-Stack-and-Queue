...
console.log("display stack: ", display(stack))
...
console.log('is palendrome? ', is_palindrome("dad"));
console.log('is palendrome? ', is_palindrome("A man, a plan, a canal: Panama"));
console.log('is palendrome? ', is_palindrome("1001"));
console.log('is palendrome? ', is_palindrome("Tauhida"));
